...
<div id="page-footer-background">
            <footer id="page-footer" class="footer reusable-container section">
                ...
                <div class="footer__socials">
                    <!-- Logo -->
                    <img class="footer__logo" id="footer-logo" src="images/nm-logo-white-med.webp"
                        alt="Netmatters Logo">
                ...
                <div class="footer__links">
                    ...
                    <div id="links1" class="footer__link-row">
                        <h4 class="footer__link-header">ABOUT NETMATTERS</h4>
                        <ul>
                            <li><a href="#">News</a></li>
                    ...
                    <div id="links2" class="footer__link-row">
                        <h4 class="footer__link-header">OUR SERVICES</h4>
                        <ul>
                    ...
                    <div id="links3" class="footer__link-row">
                        <h4 class="footer__link-header">OUR INDUSTRIES</h4>
                        <ul>
                    ...
                    <div id="links4" class="footer__link-row">
                        <h4 class="footer__link-header">LOCATIONS</h4>
                        <ul>
